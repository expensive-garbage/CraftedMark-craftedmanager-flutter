...
//             content: const Text('An error occurred while updating the product.'),
//             actions: [
...
//     decoration: const InputDecoration(labelText: 'Manufacturing Price'),
//     keyboardType: TextInputType.number,
...
//     keyboardType: TextInputType.number,
//     onSaved: (value) => _backordered = value == 'true' ? true : false,
//     ),
//     const SizedBox(height: 16.0),
//     TextFormField(
...
//     decoration: const InputDecoration(labelText: 'Manufacturer Name'),
