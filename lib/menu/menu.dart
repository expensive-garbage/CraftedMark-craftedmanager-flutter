...
class MenuViewState extends State<MenuView> {
  ...
  final List<MenuItem> menuItems = [
    ...
    MenuItem(title: "Production", iconData: CupertinoIcons.gear_alt_fill, subItems: [
      MenuItem(title: "Production Schedule", iconData: CupertinoIcons.calendar),
      MenuItem(title: "Production Reports", iconData: CupertinoIcons.doc_text_fill),
    ]),
    MenuItem(title: "Orders/Invoicing", iconData: CupertinoIcons.cart_fill, subItems: [
      MenuItem(title: "Invoices", iconData: CupertinoIcons.calendar),
      MenuItem(title: "Open Orders", iconData: CupertinoIcons.doc_text_fill),
    ]),
    MenuItem(title: "Payments", iconData: CupertinoIcons.creditcard_fill),
    MenuItem(title: "Contacts", iconData: CupertinoIcons.person_2_fill, destination: const ContactsList(), subItems: [
      MenuItem(title: "Customers", iconData: CupertinoIcons.person_crop_circle_fill),
